...
| P2648 | [赚钱](https://www.luogu.com.cn/problem/P2648) | [P2648_赚钱.cpp](./P2648_赚钱.cpp) | 已通过 | Floyd、最大收益路径、正环检测 |
| P2670 | [[NOIP 2015 普及组] 扫雷游戏](https://www.luogu.com.cn/problem/P2670) | [P2670_扫雷游戏.cpp](./P2670_扫雷游戏.cpp) | 已通过 | 网格模拟、八方向枚举 |
| P2758 | [编辑距离](https://www.luogu.com.cn/problem/P2758) | [P2758_编辑距离.cpp](./P2758_编辑距离.cpp) | 已通过 | 字符串动态规划、编辑距离 |
| P2662 | [[WC2002] 牛场围栏](https://www.luogu.com.cn/problem/P2662) | [P2662_牛场围栏.cpp](./P2662_牛场围栏.cpp) | 已通过（账号；本地需修正） | 同余最短路、最大不可表示数；缺少 gcd 无解判断 |
| P3304 | [[SDOI2013] 直径](https://www.luogu.com.cn/problem/P3304) | [P3304_直径.cpp](./P3304_直径.cpp) | 未完成 | 树的直径；尚缺公共边数量 |
| P3367 | [【模板】并查集](https://www.luogu.com.cn/problem/P3367) | [P3367_并查集.cpp](./P3367_并查集.cpp) | 已通过 | 并查集、路径压缩 |
| P3376 | [【模板】网络最大流](https://www.luogu.com.cn/problem/P3376) | [P3376_网络最大流.cpp](./P3376_网络最大流.cpp) | 已通过 | Dinic、分层图、当前弧优化 |
| P3379 | [【模板】最近公共祖先（LCA）](https://www.luogu.com.cn/problem/P3379) | [P3379_最近公共祖先.cpp](./P3379_最近公共祖先.cpp) | 已通过 | 倍增、LCA、树上查询 |
| P3403 | [跳楼机](https://www.luogu.com.cn/problem/P3403) | [P3403_跳楼机.cpp](./P3403_跳楼机.cpp) | 已通过 | 同余最短路、Dijkstra、可达状态计数 |
| P3868 | [[TJOI2009] 猜数字](https://www.luogu.com.cn/problem/P3868) | [P3868_猜数字.cpp](./P3868_猜数字.cpp) | 已通过（账号；本地需修正） | 中国剩余定理；`k=1` 分支固定输出 0 |
| P3951 | [[NOIP 2017 提高组] 小凯的疑惑](https://www.luogu.com.cn/problem/P3951) | [P3951_小凯的疑惑.cpp](./P3951_小凯的疑惑.cpp) | 已通过 | 数论、裴蜀定理、Frobenius 数 |
