...
评测状态核对日期：2026-08-17。账号 `Moyichen0219` 中存在 AC 记录的仓库题目标为“已通过”；ABC246 C 的状态由用户确认，没有匹配 AC 记录的完整实现标为“未通过”或“待验证”。
...
> ABC471 F 在账号中有多次 WA、没有 AC，因此按“未通过”归档；其余本次新增 AtCoder 题目均已核对到 AC 记录。
